...
if(isset($_POST['sub'])){
    ...
    $citydescription=mysqli_real_escape_string($conn,$_POST['citydescription']);
        ...
        $sql="UPDATE `city` SET `cityname`='$cityname',`citydescription`='$citydescription' WHERE `city_id`='$id'";
        $run=mysqli_query($conn,$sql);
        if($run){
            $msg="Data updated";
            header("Refresh:2,url=./cityview.php");
        }else{
                  ...
                  <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group ">
                        ...
                        <textarea type="text" class="form-control" required="" value="<?php echo $tfet['citydescription']?>" name="citydescription"><?php echo $tfet['citydescription']?></textarea>
                      </div>
