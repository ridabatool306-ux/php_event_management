...
?>
      ...
      <div class="main-content">
        <section class="section">
          <div class="row ">
            <?php
            if($iaccess=='planner' || $iaccess=='admin'){
            ?>
                    ...
                    <div class="row ">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          ...
                          <h2 class="mb-3 font-18"><?php echo $total ;?></h2>
            ...
            if($iaccess=='volunteer' || $iaccess=='admin'){
            ?>
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <div class="card">
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                    <?php
                      $csql="SELECT COUNT(*) AS total FROM `volunteer`";
            ...
            if($iaccess=='designer' || $iaccess=='admin'){
            ?>
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <div class="card">
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                    <?php
                      $dsql="SELECT COUNT(*) AS total FROM `designer`";
            ...
            if($iaccess=='designer' || $iaccess=='planner'|| $iaccess=='volunteer'|| $iaccess=='admin'){
            ?>
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <div class="card">
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                    <?php
                      $vsql="SELECT COUNT(*) AS total FROM `category`";
                      $vrun=mysqli_query($conn,$vsql);
                      if($vrun){
                        $fet=mysqli_fetch_assoc($vrun);
                        $total=(int) $fet['total'];
                      }else{
                        $total=0;
                      }
              ...
              <div class="card">
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                   <div class="row ">
                     <?php
                      $esql="SELECT COUNT(*) AS total FROM `event`";
                      $erun=mysqli_query($conn,$esql);
                      if($erun){
                        $fet=mysqli_fetch_assoc($erun);
                        $total=(int) $fet['total'];
                      }else{
                        $total=0;
                      }
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <div class="card">
                <div class="card-statistic-4">
                  ...
                  <div class="row ">
                    <?php
                      $nsql="SELECT COUNT(*) AS total FROM `news`";
                      $nrun=mysqli_query($conn,$nsql);
                      if($nrun){
                        $fet=mysqli_fetch_assoc($nrun);
                        $total=(int) $fet['total'];
                      }else{
                        $total=0;
                      }
              ...
              <div class="card">
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                    <?php
                      $vsql="SELECT COUNT(*) AS total FROM `venue`";
                      $vrun=mysqli_query($conn,$vsql);
                      if($vrun){
                        $fet=mysqli_fetch_assoc($vrun);
                        $total=(int) $fet['total'];
              ...
              <div class="card">
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                    <?php
                      $csql="SELECT COUNT(*) AS total FROM `city`";
                      $crun=mysqli_query($conn,$csql);
                      if($crun){
                        $fet=mysqli_fetch_assoc($crun);
                        $total=(int) $fet['total'];
          ...
          <?php
            ...
            if($iaccess=='designer' || $iaccess=='planner'|| $iaccess=='volunteer') {
              ?>
    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-xs-12">
      <div class="card">
        <div class="card-statistic-4">
          <div class="align-items-center justify-content-between">
            <div class="row ">
            <?php
              $csql="SELECT COUNT(*) AS total FROM `specificbooking` WHERE `email`=$email";
              $crun=mysqli_query($conn,$csql);
              if($crun){
                $fet=mysqli_fetch_assoc($crun);
                $total=(int) $fet['total'];
      ...
      <div class="card">
        <div class="card-statistic-4">
          <div class="align-items-center justify-content-between">
            <div class="row ">
            <?php
              $csql="SELECT COUNT(*) AS total FROM `specificbooking`";
              $crun=mysqli_query($conn,$csql);
              if($crun){
                $fet=mysqli_fetch_assoc($crun);
                $total=(int) $fet['total'];
